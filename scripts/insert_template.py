...
from scripts.templates.incorrect_value_error_template import incorrect_value_template
from scripts.templates.required_value_error_template import required_value_template
...
TEMPLATES = {
	...
	"uuid": uuid_template,
	"incorrect_value": incorrect_value_template,
	"required_value": required_value_template
}
